...
#Request 
use App\Http\Requests\User\Transport\OrdersProfitsExpenses\StoreRequest;
use App\Http\Requests\User\Transport\OrdersProfitsExpenses\UpdateRequest;
...
class OrdersProfitsExpensesController extends Controller
{
    ...
    {
        $data = OrdersProfitsExpenses::where('order_id','=',$id)->get();
        $response = $data;
    ...
    public function store(StoreRequest $request)
    {
        try 
        {
            ...
            $record = new OrdersProfitsExpenses();
    ...
    public function update(UpdateRequest $request,$id)
    {
        try 
        {
            ...
            $record = OrdersProfitsExpenses::find($id);
    ...
    {
        $record = OrdersProfitsExpenses::where('id','=',$id)->first();
