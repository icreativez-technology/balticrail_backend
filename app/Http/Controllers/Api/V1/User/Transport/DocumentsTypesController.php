...
#Model
use App\Models\Transport\DocumentsTypes;

#Request 
use App\Http\Requests\User\Transport\DocumentsTypes\StoreRequest;
use App\Http\Requests\User\Transport\DocumentsTypes\UpdateRequest;
...
class DocumentsTypesController extends Controller
{
    ...
    {
        $records = DocumentsTypes::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = DocumentsTypes::where('id','=',$id)->first();
