...
#Model
use App\Models\Transport\Units;

#Request 
use App\Http\Requests\User\Transport\Units\StoreRequest;
use App\Http\Requests\User\Transport\Units\UpdateRequest;
...
class UnitsController extends Controller
{
    ...
    {
        $records = Units::paginate($this->pagination);
        $response = $records;
