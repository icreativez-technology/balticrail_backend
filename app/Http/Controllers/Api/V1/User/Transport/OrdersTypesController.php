...
#Model
use App\Models\Transport\OrdersTypes;


#Request 
use App\Http\Requests\User\Transport\OrdersTypes\StoreRequest;
use App\Http\Requests\User\Transport\OrdersTypes\UpdateRequest;
...
class OrdersTypesController extends Controller
{
    ...
    {
        $records = OrdersTypes::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = OrdersTypes::where('id','=',$id)->first();
