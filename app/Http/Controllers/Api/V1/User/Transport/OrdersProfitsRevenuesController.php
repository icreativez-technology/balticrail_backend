...
#Request 
use App\Http\Requests\User\Transport\OrdersProfitsRevenues\StoreRequest;
use App\Http\Requests\User\Transport\OrdersProfitsRevenues\UpdateRequest;
...
class OrdersProfitsRevenuesController extends Controller
{
    ...
    {
        $data = OrdersProfitsRevenues::where('order_id','=',$id)->get();
        $response = $data;
    ...
    public function store(StoreRequest $request)
    {
        try 
        {
            ...
            $record = new OrdersProfitsRevenues();
    ...
    public function update(UpdateRequest $request,$id)
    {
        try 
        {
            ...
            $record = OrdersProfitsRevenues::find($id);
    ...
    {
        $record = OrdersProfitsRevenues::where('id','=',$id)->first();
