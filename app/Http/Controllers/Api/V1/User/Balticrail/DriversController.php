...
#Request 
use App\Http\Requests\User\Balticrail\Drivers\StoreRequest;
use App\Http\Requests\User\Balticrail\Drivers\UpdateRequest;
...
class DriversController extends Controller
{
    ...
    {
        $records = Drivers::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = Drivers::where('id','=',$id)->first();
