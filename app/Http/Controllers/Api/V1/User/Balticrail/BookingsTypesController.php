...
#Request 
use App\Http\Requests\User\Balticrail\BookingsTypes\StoreRequest;
use App\Http\Requests\User\Balticrail\BookingsTypes\UpdateRequest;

#Trait
use App\Http\Traits\CommonFunctionsTrait;
use App\Http\Traits\ImageFunctionsTrait;

class BookingsTypesController extends Controller
{
    ...
    {
        $records = BookingsTypes::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = BookingsTypes::where('id','=',$id)->first();
