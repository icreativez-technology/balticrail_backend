...
#Request 
use App\Http\Requests\User\Balticrail\Containers\StoreRequest;
use App\Http\Requests\User\Balticrail\Containers\UpdateRequest;
...
class ContainersController extends Controller
{
    ...
    {
        $records = Containers::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = Containers::where('id','=',$id)->first();
