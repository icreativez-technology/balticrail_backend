...
#Model
use App\Models\Balticrail\BookingsServicesServices;
...
#Request 
use App\Http\Requests\User\Balticrail\BookingsServicesServices\StoreRequest;
use App\Http\Requests\User\Balticrail\BookingsServicesServices\UpdateRequest;

class BookingsServicesServicesController extends Controller
{
    public $pagination;
    ...
    public function index($id)
    {
        ...
        $data = BookingsServicesServices::where('booking_id','=',$booking->id)->paginate($this->pagination);
    ...
    public function save_booking_service_service($data,$id = 0)
    {
        if($id > 0)
        {
            $record = BookingsServicesServices::find($id);
        }
        else
        {
            $record = new BookingsServicesServices();
    ...
    public function show($id)
    {
        try
        {
            $booking = BookingsServicesServices::find($id);
    ...
    public function update(UpdateRequest $request, $id)
    {
        try
        {
            ...
            if(isset($booking->id))
            {
                $booking = BookingsServicesServices::where('booking_id','=',$booking->id)->find($id);
