...
#Model
use App\Models\Railway\Languages;

#Request 
use App\Http\Requests\User\Languages\StoreRequest;
use App\Http\Requests\User\Languages\UpdateRequest;
...
class LanguagesController extends Controller
{
    ...
    {
        $records = Languages::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = Languages::where('id','=',$id)->first();
