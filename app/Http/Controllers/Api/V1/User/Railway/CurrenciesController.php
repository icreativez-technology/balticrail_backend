...
#Model
use App\Models\Railway\Currencies;

#Request 
use App\Http\Requests\User\Currencies\StoreRequest;
use App\Http\Requests\User\Currencies\UpdateRequest;
...
class CurrenciesController extends Controller
{
    ...
    {
        $records = Currencies::paginate($this->pagination);
        $response = $records;
    ...
    {
        $record = Currencies::where('id','=',$id)->first();
